...
import { DialProvider } from "./dial.mjs";
...
export { DialProvider } from "./dial.mjs";
...
export function createLLMProvider(llmConfig) {
  ...
  switch (provider.toLowerCase()) {
    ...
    case 'dial':
      // DIAL is self-hosted: baseUrl and apiVersion come from config, and the
      // deployment name doubles as the model id.
      return new DialProvider({
        apiKey, model,
        baseUrl: llmConfig.dialBaseUrl,
        apiVersion: llmConfig.dialApiVersion,
      });
    default:
      console.warn(
